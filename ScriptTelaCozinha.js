...
let audioFiles = [
    ...
    "Vozes/TelaCozinha/1.mp3",  // Áudio correspondente ao segundo texto
    "Vozes/TelaCozinha/2.mp3",  // Áudio correspondente ao terceiro texto
    "Vozes/TelaCozinha/3.mp3"   // Áudio correspondente ao quarto texto
];
...
// Inicializa a primeira linha de texto e o áudio
...
continueButton.addEventListener('click', () => {
    ...
    if (textIndex < textArray.length - 1) {
        ...
        window.location.href = 'TelaCozinhaJogo.html'; 
    }
});
